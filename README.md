...
##### ***Примечание:*** 
в данной версии реализован механизм отмены действия текущего access-токена в случае получения нового (предусмотрено на случай компрометации текущего токена).
